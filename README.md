...
Проект був розроблений в рамках дипломної роботи та призначений для
автоматизованого налаштування щойно створеного віддаленого сервера,
а також завантаження і запуску на ньому
[іншого](https://github.com/wadofan/mage-docker) проекта.
...
з [цього проекту](https://github.com/wadofan/mage-tf-config).
...
Крім змінних, що використовуються у ролях і будуть розглянуті нижче, 
існують також змінні, що знаходяться у файлі `group_vars/all/vars.yml` 
і використовуються для групи `all`, тобто для всіх хостів.
